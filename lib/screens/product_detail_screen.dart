  ...
  Widget _buildProductImage() {
    ...
    return AspectRatio(
      ...
      child: Container(
        ...
        child: Image.asset(
          'images/sambablue.jpeg', // <-- Path sesuai deklarasi di pubspec.yaml
          ...
          // dll.
          semanticLabel: 'Sepatu Casual', // Deskripsi untuk aksesibilitas
        ),
      ),
    );
  }
  ...
  Widget _buildProductInfo(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Sepatu Casual Samba Blue White',
          ...
          const SizedBox(height: 8.0),
          Text(
            'Tampil percaya diri setiap langkah dengan Samba – sepatu ikonik bergaya klasik yang nyaman dan cocok untuk segala aktivitas',
